...
;(function($){
    ...
    $.fn.placeholder = function( settings ){
        ...
        var opts=$.extend({
            ...
            //input父类CSS
            parentStyle : 'position:relative;display:inline-block;overflow:hidden;width:100%;',
            //placehodler元素CSS
            placeStyle : 'position:absolute;z-index:2;top:50%;left:0;width:100%;margin-top:-10px;box-sizing:border-box;color:#999;line-height:20px;font-size:16px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;'
        },settings||{});
